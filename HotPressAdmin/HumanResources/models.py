...
class Children(models.Model):
    ...
    sex = models.CharField(max_length=32, choices=(('male', 'male'), ('female', 'female'), ('otherother', 'other')),
                           blank=True)
    date_of_birth = models.DateField(blank=True, null=True)


class DisciplinaryAction(models.Model):
    employee = models.ForeignKey(Employee, blank=True, null=True, related_name='DisciplinaryAction',
...
class Address(models.Model):
    ...
    date_from = models.DateField(blank=True, null=True)
    date_to = models.DateField(blank=True, null=True)
    address_type = models.CharField(max_length=32, choices=(('present', 'present'), ('permanent', 'permanent')),
                                    blank=True)
...
class Rest_and_recreation(models.Model):
    employee = models.ForeignKey(Employee, blank=True, null=True, related_name='Rest_and_recreation',
                                 on_delete=models.CASCADE)
    date_from = models.DateField(blank=True, null=True)
    date_to = models.DateField(blank=True, null=True)
...
class Retirement_year(models.Model):
    employee = models.ForeignKey(Employee, blank=True, null=True, related_name='Retirement_year',
                                 on_delete=models.CASCADE)
...
class ServiceHistory(models.Model):
    employee = models.ForeignKey(Employee, blank=True, null=True, related_name='ServiceHistory',
                                 on_delete=models.CASCADE)
    designation = models.CharField(max_length=255, blank=True, null=True)
...
class Employee_Achievement(models.Model):
    points_to = models.ForeignKey(Employee, blank=True, null=True, related_name='EmployeeAchievement',
                                  on_delete=models.CASCADE)
    points_by = models.ForeignKey(Employee, blank=True, null=True, related_name='ManagerAchievement',
                                  on_delete=models.CASCADE)
